...
const clickEsquerdo = (event)=>{
    ...
    const confirmUpdate = window.confirm(`Clicou com o bot\xe3o direito, e o ${data[currentId].getNome().toUpperCase()} ser\xe1 carregado para edi\xe7\xe3o 
 
  Voc\xea realmente deseja carregar a edi\xe7\xe3o?`);
    if (confirmUpdate) updateUser(currentId);
    (0, _viewControllerJs.viewController).update(data, new (0, _usuarioModelJs.Usuario)("", null, "", ""));
};
